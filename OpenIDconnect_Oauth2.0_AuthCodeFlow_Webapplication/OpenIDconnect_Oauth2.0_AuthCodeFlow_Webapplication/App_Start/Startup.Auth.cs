...
using OpenIDconnect_Oauth2._0_AuthCodeFlow_Webapplication.cache;
using System.Web;
...
namespace OpenIDconnect_Oauth2._0_AuthCodeFlow_Webapplication
{
    ...
    {
        // The Client ID is used by the application to uniquely identify itself to Azure AD.ClientID we will get after registering this application on Azure AD
